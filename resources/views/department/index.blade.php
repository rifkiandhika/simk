...
@section('breadcrumb')
    <li class="breadcrumb-item text-primary" aria-current="page">Department</li>
@endsection
                ...
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <p class="text-muted mb-1 small">Nonaktif</p>
                ...
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <p class="text-muted mb-1 small">Medis</p>
                                <h4 class="mb-0">{{ $totalMedis }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="flex-shrink-0">
                                <div class="avatar-sm rounded-circle bg-warning bg-soft">
                                    <span class="avatar-title rounded-circle bg-warning bg-gradient">
                                        <i class="ri-briefcase-line fs-4 text-white"></i>
                                    </span>
                                </div>
                            </div>
                            <div class="flex-grow-1 ms-3">
                                <p class="text-muted mb-1 small">Non-Medis</p>
                                <h4 class="mb-0">{{ $totalNonMedis }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <p class="text-muted mb-1 small">Penunjang</p>
                                <h4 class="mb-0">{{ $totalPenunjang }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-white py-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="mb-0">
                                <i class="ri-list-check-2 me-2"></i>Daftar Department
                            </h5>
                            <a class="btn btn-primary btn-sm" href="{{ route('departments.create') }}">
                                <i class="ri-add-circle-line me-1"></i>Tambah Department
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card-body border-bottom bg-light">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control form-control-sm" id="searchBox" placeholder="Cari kode atau nama department...">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover table-striped align-middle" id="departmentTable">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th width="180">Kepala Department</th>
                                ...
                                <tbody>
                                    @forelse ($departments as $x => $data)
                                        <tr>
                                            <td class="text-center">{{ $x + 1 }}</td>
                                            <td>
                                                <code class="text-primary fw-bold">{{ $data->kode_department }}</code>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-xs me-2">
                                                        <span class="avatar-title rounded-circle bg-soft-primary text-primary">
                                                            {{ substr($data->nama_department, 0, 1) }}
                                                        </span>
                                                    </div>
                                                    <div>
                                                        <strong>{{ $data->nama_department }}</strong>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                @if($data->lokasi)
                                                    <small class="text-muted">
                                                        <i class="ri-map-pin-line"></i> {{ $data->lokasi }}
                                                    </small>
                                                @else
                                            ...
                                            <td>
                                                @if($data->kepala_department)
                                                    <small class="text-muted">
                                                        <i class="ri-user-line"></i> {{ $data->kepala_department }}
                                                    </small>
                                                @else
                                                    <span class="text-muted">-</span>
                                                @endif
                                            ...
                                            <td>
                                                @php
                                                    $badgeClass = match($data->jenis) {
                                                        'Medis' => 'bg-info',
                                                        'Non-Medis' => 'bg-warning text-dark',
                                                        'Penunjang' => 'bg-purple',
                                                        default => 'bg-secondary'
                                                    };
                                                    $iconClass = match($data->jenis) {
                                                        'Medis' => 'ri-hospital-line',
                                                        'Non-Medis' => 'ri-briefcase-line',
                                                        'Penunjang' => 'ri-tools-line',
                                                        default => 'ri-building-line'
                                                    };
                                                @endphp
                                                <span class="badge {{ $badgeClass }}">
                                                    <i class="{{ $iconClass }}"></i> {{ $data->jenis }}
                                                </span>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end shadow">
                                                        {{-- <li>
                                                            <a class="dropdown-item" href="{{ route('departments.show', $data->id) }}">
                                                                <i class="ri-eye-line me-2"></i> Detail
                                                            </a>
                                                        </li> --}}
                                                        <li>
                                                            <a class="dropdown-item" href="{{ route('departments.edit', $data->id) }}">
                                                                <i class="ri-pencil-fill me-2"></i>Edit
                                                            </a>
                                                        </li>
                                                        <li><hr class="dropdown-divider"></li>
                                                        <li>
                                                            <form action="{{ route('departments.destroy', $data->id) }}" method="POST" class="delete-confirm">
                                                                @csrf
                                                                @method('DELETE')
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="8" class="text-center py-5">
                                                ...
                                                <p class="text-muted mb-0">Belum ada data department</p>
                    ...
                    try {
                        dataTable = $table.DataTable({
                            ...
                            language: {
                                ...
                                emptyTable: "Belum ada data department"
                            },
                            columnDefs: [
                        ...
                        $('#filterJenis').on('change', function() {
                            ...
                            dataTable.column(5).search(selectedJenis).draw();
                        });
