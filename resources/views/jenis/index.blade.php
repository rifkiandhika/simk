...
@section('breadcrumb')
    <li class="breadcrumb-item text-primary" aria-current="page">Jenis</li>
@endsection
...
<div class="app-body">
        ...
        <div class="col-xl-4 col-md-6 mb-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        <p class="text-muted mb-1">Total Jenis</p>
                        <h4 class="mb-0">{{ $jenis->count() }}</h4>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-4 col-md-6 mb-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        <p class="text-muted mb-1">Jenis Aktif</p>
                        <h4 class="mb-0">{{ $jenis->where('status', 'Aktif')->count() }}</h4>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-4 col-md-6 mb-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        <p class="text-muted mb-1">Jenis Nonaktif</p>
                        <h4 class="mb-0">{{ $jenis->where('status', 'Nonaktif')->count() }}</h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
            <h5 class="mb-0"><i class="ri-database-2-line me-2"></i>Daftar Jenis</h5>
            <a href="{{ route('jenis.create') }}" class="btn btn-primary btn-sm">
                <i class="ri-add-circle-line me-1"></i>Tambah Jenis
            </a>
        </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                @if($jenis->count() > 0)
                    <table class="table table-hover table-striped align-middle" id="jenisTable">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-xs me-2">
                                                <span class="avatar-title rounded-circle bg-soft-primary text-primary">
                                                    {{ substr($data->nama_jenis, 0, 1) }}
                                                </span>
                                            </div>
                                            <div>
                                                <strong>{{ $data->nama_jenis }}</strong>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end shadow">
                                                <li>
                                                    <a href="{{ route('jenis.edit', $data->id) }}" class="dropdown-item">
                                                        <i class="ri-pencil-line me-2"></i>Edit
                                                    </a>
                                                </li>
                                                <li>
                                                    <form action="{{ route('jenis.destroy', $data->id) }}" method="POST" class="delete-confirm">
                                                        @csrf
                                                        @method('DELETE')
                ...
                @else
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted mb-2">Belum ada data jenis</p>
                        <a href="{{ route('jenis.create') }}" class="btn btn-primary btn-sm">
                            <i class="ri-add-circle-line me-1"></i>Tambah Jenis
                        </a>
                    </div>
